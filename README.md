...
#### [class](036c) `openrpc-server/api:api` ()

<a id="x-28OPENRPC-SERVER-2FAPI-3A-2ACURRENT-API-2A-20-28VARIABLE-29-29"></a>

#### [variable](c65b) `openrpc-server/api:*current-api*` -unbound-
...
#### [macro](bad8) `openrpc-server/api:define-api` (NAME &KEY (TITLE "Default API") (VERSION "0.1.0")) &BODY SLOTS

<a id="x-28OPENRPC-SERVER-2FAPI-3AAPI-METHODS-20-2840ANTS-DOC-2FLOCATIVES-3AREADER-20OPENRPC-SERVER-2FAPI-3AAPI-29-29"></a>

#### [reader](d194) `openrpc-server/api:api-methods` (api) (= (make-hash-table :test 'equal))
...
#### [reader](09ad) `openrpc-server/api:api-title` (api) (:TITLE = "Default API")
...
#### [reader](18aa) `openrpc-server/api:api-version` (api) (:version = "0.1.0")
...
#### [macro](69f9) `openrpc-server/method:define-rpc-method` name args &body body
...
#### [generic-function](e9c0) `openrpc-server/interface:type-to-schema` type
...
#### [generic-function](e145) `openrpc-server/interface:transform-result` object
...
#### [generic-function](5bfd) `openrpc-server/interface:primitive-type-p` type
...
#### [generic-function](8f78) `openrpc-server/interface:make-info` api
...
#### [function](9048) `openrpc-server/errors:return-error` message &key (code -1) (error-class 'jsonrpc/errors:jsonrpc-callback-error)
...
#### [generic-function](f41b) `openrpc-server/clack:make-clack-app` api &key http websocket indent-json
...
#### [generic-function](4dfb) `openrpc-server/clack:app-middlewares` api
...
#### [function](0bc8) `openrpc-server/clack:debug-on`

<a id="x-28OPENRPC-SERVER-2FCLACK-3ADEBUG-OFF-20FUNCTION-29"></a>

#### [function](99e2) `openrpc-server/clack:debug-off`

<a id="x-28OPENRPC-SERVER-2FINTERFACE-3ASLOTS-TO-EXCLUDE-20GENERIC-FUNCTION-29"></a>

#### [generic-function](1f7a) `openrpc-server/interface:slots-to-exclude` type
...
### [macro](7cbd) `openrpc-client/core:generate-client` class-name url-or-path &key (export-symbols t)
...
[7cbd]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/client/core.lisp#L522
[c65b]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/api.lisp#L14
[036c]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/api.lisp#L18
[d194]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/api.lisp#L19
[09ad]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/api.lisp#L27
[18aa]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/api.lisp#L31
[bad8]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/api.lisp#L39
[0bc8]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/clack.lisp#L181
[99e2]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/clack.lisp#L186
[f41b]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/clack.lisp#L67
[4dfb]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/clack.lisp#L74
[9048]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/errors.lisp#L9
[8f78]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/interface.lisp#L167
[e145]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/interface.lisp#L21
[5bfd]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/interface.lisp#L56
[1f7a]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/interface.lisp#L72
[e9c0]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/interface.lisp#L85
[69f9]: https://github.com/40ants/openrpc/blob/d200d1687dce5f1350d0eee29b5d278d87f596a5/server/method.lisp#L313
